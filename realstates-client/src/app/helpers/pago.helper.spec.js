describe('PagoHelper', function() {
  ...
  describe('alquilerAPuntoDeVencer', function() {
    ...
    it('should return false when the expire day is 10th, the current day is the 11th and the last payment was a month before', function() {
      ...
      var rentExpired = pagoHelper.alquilerAPuntoDeVencer(expireDay, lastPayment, currentDate);

      expect(rentExpired).toBeFalsy();
    });

    xit('should return false when the expire day is 10th, the current day is the 11th and the last payment was a done the 3rd of the currentDate', function() {
      var currentDate = new Date(2015, 7, 11);
      var lastPayment = new Date(2015, 7, 3);
      var expireDay = 10;
    ...
    xit('should return false when the expire day is 10th, the current day is the 4th and the last payment was the provious month', function() {
      var currentDate = new Date(2015, 7, 4);
      var lastPayment = new Date(2015, 6, 4);
      var expireDay = 10;
